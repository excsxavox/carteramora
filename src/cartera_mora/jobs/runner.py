...
from cartera_mora.jobs.container import build_procesar_cartera_mora_use_case
...
def main() -> int:
    ...
    logger = logging.getLogger("cartera_mora.job")
    ...
    try:
        use_case = build_procesar_cartera_mora_use_case(settings)
